...
SVSOLVER_PATH    = '/home/khanmu11/Softwares/svsolver/BuildWithMake/svSolver-build/bin/svsolver'
PRESOLVER_PATH = '/home/khanmu11/Softwares/svsolver/BuildWithMake/svSolver-build/bin/svpre'
POSTSOLVER_PATH = '/home/khanmu11/Softwares/svsolver/BuildWithMake/svSolver-build/bin/svpost'
...
SOLVER_SCRIPT = 'Trillium_flowsolver_script'
...
def runScript_base(scriptName, jobName, time, nodes, procs):
  ...
  scriptFile.write("module purge; module load gcc openmpi openblas cmake metis vtk/9.3.0 swig boost\n")
...
def makePresolver_script():
  runScript_base('presolve_batch', 'svPre', 1, 1, PROCESSORS)
...
########################### Run FSI Presolve ########################
  ...
  infile=open("%s/Coronary_Flow_Split_Iteration%d/rigid_coronary_tuning_and_simulation/coronaryLPN_FSI.svpre"%(ProjectNameCoarse,ITERATION),'r')
  ...
  os.system("cp %s/Coronary_Flow_Split_Iteration%d/FSI_coronary_tuning_and_simulation/coronaryModel.txt ./"%(ProjectNameCoarse,ITERATION)) 
  os.system("cp %s/Coronary_Flow_Split_Iteration%d/FSI_coronary_tuning_and_simulation/coronaryParams.txt ./"%(ProjectNameCoarse,ITERATION))    
  os.system("cp %s/Coronary_Flow_Split_Iteration%d/FSI_coronary_tuning_and_simulation/GenBC ./"%(ProjectNameCoarse,ITERATION))
...
############################ Run the Solver ##########################################
  ...
  infile=open("%s/Coronary_Flow_Split_Iteration2/FSI_coronary_tuning_and_simulation/solver.inp"%ProjectNameCoarse,'r')
  ...
  infile=open("solver_files/Trillium_flowsolver_script",'r')
  outfile=open("Trillium_flowsolver_script",'w')
  for line in infile:
    ...
    elif line.find("#SBATCH --nodes=1")>=0:
      outfile.write("#SBATCH --nodes=2\n")
  ...
  os.system(BATCH_COMMAND + " Trillium_flowsolver_script") 
